...
For more results generated by different samplers, see the examples in [Test Generation](https://github.com/chairc/Integrated-Design-Diffusion-Model/tree/main/test/generate_test).
